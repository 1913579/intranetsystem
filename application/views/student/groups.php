                    ...
                    <tbody>
                        <?php if(!empty($groups)){
                            foreach($groups as $group){
                                ...
                                echo "<td><a href='".base_url()."Student/team/".$group->id."'>Group Members</a></td>";
                                echo "<td><a href='".base_url()."Student/assignwork/".$group->id."'>Assign Work</a></td>";
                                echo "<td><a href='".base_url()."Student/deletegroup/".$group->id."'>Delete</a></td>";
                                echo "</tr>";
                            }
                        } ?>
                    </tbody>
