...
$(".result").html("");
        ...
        if(inputVal.length){
            $.post("<?php echo base_url();?>Student/searchUser", {term: inputVal}).done(function(data){
...
function addMember($id){
    $.ajax({
            type: "POST",
            url: "<?php echo base_url();?>Student/addMember",
            data: {
            uid:$id,
            pid:<?php echo $pid;?>		
			}
 ...
 function teamlead(tid){
    ...
    $.ajax({
            type: "POST",
            url: "<?php echo base_url();?>Student/teamLead",
            data: {
            tid:tid	
			}
        }).done(function (result) {
...
function remove(tid){
    $.ajax({
            type: "POST",
            url: "<?php echo base_url();?>Student/removemem",
            data: {
            tid:tid	
			}
        }).done(function (result) {
