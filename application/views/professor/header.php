...
<body>
  ...
  <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
          ...
          <a class="dropdown-item" href="<?php echo base_url();?>Professor/process_logout">Logout Account</a>
...
<hr>  
                ...
                <li class="nav-item"><a href="<?php echo base_url();?>Professor" class="nav-link slink" id="dashboard">
                ...
                <li class="nav-item"><a href="<?php echo base_url();?>Professor/newgroup" class="nav-link slink" id="newg">
                        <i class="material-icons icon">
                            group_add
                ...
                <li class="nav-item"><a href="<?php echo base_url();?>Professor/groups" class="nav-link slink" id="groups">
                        <i class="material-icons icon">
                            people
                ...
                <li class="nav-item"><a href="<?php echo base_url();?>Professor/submittedwork" class="nav-link slink" id="submittedwork">
                        <i class="material-icons icon">
                            work
                        </i><span class="text">Submitted Work</span>
                    </a>
