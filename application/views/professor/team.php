...
<div class="col-lg-6">
        ...
        <input type="text" autocomplete="off" id="SearchU" class="fullwidth" placeholder="Search Student..." />
        <ul class="result"></ul>
    </div>
...
$(".result").html("");
        ...
        if(inputVal.length){
            $.post("<?php echo base_url();?>Professor/searchUser", {term: inputVal}).done(function(data){
...
function addMember($id){
    $.ajax({
            type: "POST",
            url: "<?php echo base_url();?>Professor/addMember",
            data: {
            uid:$id,
            pid:<?php echo $pid;?>		
			}
 ...
 function teamlead(tid){
    ...
    $.ajax({
            type: "POST",
            url: "<?php echo base_url();?>Professor/teamLead",
            data: {
            tid:tid	
			}
        }).done(function (result) {
...
function remove(tid){
    $.ajax({
            type: "POST",
            url: "<?php echo base_url();?>Professor/removemem",
            data: {
            tid:tid	
			}
        }).done(function (result) {
