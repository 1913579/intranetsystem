...
<body>
  ...
  <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
          ...
          <a class="dropdown-item" href="<?php echo base_url();?>Admin/process_logout">Logout Account</a>
...
<hr>  
                ...
                <li class="nav-item"><a href="<?php echo base_url();?>Admin" class="nav-link slink" id="dashboard">
                ...
                <li class="nav-item"><a href="<?php echo base_url();?>Admin/newuser" class="nav-link slink" id="newu">
                        <i class="material-icons icon">
                        person_add
                        </i><span class="text">New User</span>
                    </a>
               
                </li>

                <li class="nav-item"><a href="<?php echo base_url();?>Admin/users" class="nav-link slink" id="users">
                        <i class="material-icons icon">
                            person
                ...
                <li class="nav-item"><a href="<?php echo base_url();?>Admin/newgroup" class="nav-link slink" id="newg">
                        <i class="material-icons icon">
                            group_add
                ...
                <li class="nav-item"><a href="<?php echo base_url();?>Admin/groups" class="nav-link slink" id="groups">
                        <i class="material-icons icon">
                            people
